...
> **The prompts below have been promoted to
> [`prompts/`](../../prompts/)**, the canonical discoverable location:
> `03-azure-monitor-backend.md` and `04-mcp-service-handoff.md`. This file
> is kept as the tracker record.
